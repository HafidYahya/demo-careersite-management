...
<div class="content-wrapper">
    <div class="page-header bg-white px-3 py-3 rounded shadow">
        <h2 class="text-danger fw-bold">FOOTER SECTION</h2>
    </div>
    <div class="navbar-image-preview-header mt-3">
        <img class="img-fluid" src="{{ asset('images/footer-image-preview-header.png') }}" alt="footer-image-preview-header">
    </div>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('footer.edit', $item['id']) }}" class="btn btn-warning btn-sm">
                                    Edit
                                </a>
                            </td>
                        </tr>
